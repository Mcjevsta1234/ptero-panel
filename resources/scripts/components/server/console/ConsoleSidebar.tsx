        ...
        <div className="space-y-4">
            ...
            <div className="bg-gray-700 border border-gray-600 rounded-lg p-4">
                <div className="flex items-center gap-3 mb-3">
                    ...
                    <div className="flex-1">
                        <div className="text-xs text-gray-400 uppercase tracking-wide">Network (Inbound / Outbound)</div>
                        <div className="text-lg font-semibold text-white">
                ...
                <div className="mt-3 pt-3 border-t border-gray-600">
                    ...
                    <div className="text-sm font-medium text-white">
                        <div className="flex items-center gap-2">
                            <svg className="w-4 h-4 text-witchyworlds" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M9 2a1 1 0 000 2h2a1 1 0 100-2H9z" />
                                <path fillRule="evenodd" d="M4 5a2 2 0 012-2 3 3 0 003 3h2a3 3 0 003-3 2 2 0 012 2v11a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm3 4a1 1 0 000 2h.01a1 1 0 100-2H7zm3 0a1 1 0 000 2h3a1 1 0 100-2h-3zm-3 4a1 1 0 100 2h.01a1 1 0 100-2H7zm3 0a1 1 0 100 2h3a1 1 0 100-2h-3z" clipRule="evenodd" />
                            </svg>
                            <span>{limits.cpu}% CPU / {bytesToString(memoryLimitBytes)} RAM</span>
                        </div>
                    </div>
                </div>
            </div>
