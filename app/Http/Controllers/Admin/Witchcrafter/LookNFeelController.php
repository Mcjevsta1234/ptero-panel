...
use Pterodactyl\Http\Requests\Admin\Witchcrafter\LookNFeelSettingsFormRequest;
...
class LookNFeelController extends Controller
{
    ...
    {
        return $this->view->make('admin.witchcrafter.looks');
    }
    ...
    public function update(LookNFeelSettingsFormRequest $request): RedirectResponse
    {
        ...
        return redirect()->route('admin.witchcrafter.looks');
    }
}
